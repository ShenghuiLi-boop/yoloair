...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    last, best = w / 'last.pt', w / 'baseline_best.pt'
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='configs/myimprove/attention/yolov5_ShuffleAttention_3_1.yaml', help='model.yaml path')
